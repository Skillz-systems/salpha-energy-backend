...
describe('InventoryController', () => {
  ...
  let warehouseInventoryService: WarehouseInventoryService;
  ...
  beforeEach(async () => {
    ...
    warehouseInventoryService = module.get<WarehouseInventoryService>(WarehouseInventoryService);
  });
  ...
  describe('Create Inventory', () => {
    it('should create inventory', async () => {
      ...
      expect(warehouseInventoryService.createInventory).toHaveBeenCalledWith(
        createInventoryDto,
        mockFile,
      );
